  ...
  function Demo(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "handleImportOffer", function () {
      ...
      if (index === 0) {
        ...
        console.log('--------------------------------------------------');
        console.log('Parse complete!');
        console.log('Row count: ', _results2.data.length);
        console.log('Errors: ', _results2.errors.length);
        console.log('Results: ', _results2);
        console.log('Synchronous results: ', _results2);
        console.log('--------------------------------------------------');
      }
    });
...
//# sourceMappingURL=demo.js.8020ebf408c4cfd138d1.hot-update.js.map